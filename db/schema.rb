...
ActiveRecord::Schema.define(version: 20210315044355) do
  ...
  create_table "orderitems", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci" do |t|
    t.bigint "order_id"
    t.bigint "menu_id"
    t.string "menu_name"
    t.integer "menu_price"
